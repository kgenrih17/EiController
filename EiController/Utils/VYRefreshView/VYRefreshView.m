...
//    CGFloat constraintWidth = CGRectGetWidth(constraintRect);
    ...
    statusLabelSize = [_statusLabel.text boundingRectWithSize:constraintRect.size
                                                      options:NSStringDrawingUsesLineFragmentOrigin
                                                   attributes:@{NSFontAttributeName:_statusLabel.font}
                                                      context:nil].size;
    
    detailsLabelSize = [_detailsLabel.text boundingRectWithSize:constraintRect.size
                                                        options:NSStringDrawingUsesLineFragmentOrigin
                                                     attributes:@{NSFontAttributeName:_detailsLabel.font}
                                                        context:nil].size;
